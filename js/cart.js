    ...
    cartItemsContainer.innerHTML = cart.map(item => `
        <div class="cart-item" data-item-id="${item.id}">
            <div class="cart-item-image">
                <img src="${item.image || 'https://via.placeholder.com/120x120/333/fff?text=منتج'}" alt="${item.name}">
            </div>
...
function updateCartSummary() {
    ...
    document.getElementById('shipping').textContent = itemsCount > 0 ? '25 جنيه' : '0 جنيه';
